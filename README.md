...
## 📐 What I Work With in Depth

**Python Typing** — I write typed Python as a standard, not an afterthought. Type hints, generics, `Protocol`, `TypeVar`, `dataclasses`, and static analysis with `mypy` / `pyright` are part of my regular workflow.

**TypeScript** — I'm very comfortable with the full type system: utility types, conditional types, mapped types, generics, declaration files, and module augmentation.
...
- ✅ Focused and independent — I work with discipline and get things done
- ✅ Strong in team settings — comfortable both receiving tasks and distributing work
- ✅ Experienced with pair programming and remote collaboration
- ✅ Familiar with setting up and managing servers, SSH workflows, and deployment environments
